                                    ...
                                    <form role="form" method="post" action="scripts/sc_users_update.php">
                                        ...
                                        if (mysqli_stmt_prepare($stmt, $query)) { // Prepare the statement
                                            ...
                                            <div class='form-group'>
                                                <label style="font-weight: bold;">ID do utilizador</label>
                                                <p class='form-control-static'><?= $id ?></p>
                                            </div>
                                            <div class='form-group'>
                                                <label style="font-weight: bold;">Data de criação</label>
                                            ...
                                            <div class='form-group'>
                                                ...
                                                <?php if ($_SESSION["id"] == $id && $_SESSION["role"] == 2) {
                                                    ...
                                                    if ($role == 2) {
                                                        ...
                                                        $roler = 1;
                                                        $roler_description = "Normal";
                                                    } else {
                                                        $role_description = "Normal";
                                                        $roler = 2;
                                                        $roler_description = "Administrador";
                                                    } ?>
                                                    <select class='form-control' name='id_roles'>
                                                        <option value='<?= $role ?>'><?= $role_description; ?></option>
                                                        <option value='<?= $roler ?>'><?= $roler_description; ?></option>
                                                    <?php } ?>
                                                    </select>
                                            </div>
                                            ...
                                            <button type='submit' class='btn' style="background-color: black; color: white">Submeter alterações
                                            </button>
